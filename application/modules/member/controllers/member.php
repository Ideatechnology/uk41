...
class member extends Front_Controller{
    ...
    public function peringkat(){
        ...
        $query=$this->db->query("SELECT round(sum(a.score)/10) as score,a.id_user,b.display_name,b.foto,c.universitas FROM `bf_hasil_ujian` a inner join bf_users b on a.id_user=b.id inner join bf_universitas c on b.universitas=c.id_universitas where a.score <> 0 group by a.id_user order by score desc limit 10")->result_array();
