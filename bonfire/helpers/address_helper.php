...
if ( ! function_exists('state_select'))
{
	...
	function state_select($selected_code='', $default_abbr='', $country_code='US', $select_name='state_code', $class='')
	{
		...
		else
		{
			...
			$output .= '<option value="" selected="selected">--Pilih Kota/Kabupaten--</option>' . PHP_EOL;
...
if ( ! function_exists('country_select'))
{
	...
	function country_select($selected_iso='', $default_iso='US', $select_name='iso', $class='' )
	{
		...
		$output .= '<option value="">--Pilih Provinsi--</option>' . PHP_EOL;
...
if ( ! function_exists('kota_select'))
{
	/**
	 * Creates a state/provience/county dropdown form input based on the entries in the address.states config.
	 * The word "state" is used but the structure can be used for Canadian proviences, Irish and UK counties and
	 ...
	 * @return string The full html for the select input.
	 */
	function kota_select($selected_code='', $default_abbr='', $select_name='kota', $class='',$provinsi='11')
	{
 	...
 	// Get the states for the selected country
			...
			$output  = '<select required name="'. $select_name . '" id="' . $select_name . '" ' . $class . ' >' . PHP_EOL;
			$output .= '<option value="">--Pilih Kota--</option>' . PHP_EOL;
			foreach ($states as $abbrev)
			{
				$output .= "<option value='{$abbrev->id_kota}'";
				$output .= ($abbrev->id_kota == $selected_code) ? ' selected="selected"' : '';
				$output .= empty($selected_code) && ($default_abbr == $abbrev->id_kota) ? ' selected="selected"' : '';
				$output .= ">{$abbrev->nama_kota}</option>\n";
			}
			$output .= "</select>\n";
...
if ( ! function_exists('provinsi_select'))
{
	/**
	 * Creates a state/provience/county dropdown form input based on the entries in the address.states config.
	 * The word "state" is used but the structure can be used for Canadian proviences, Irish and UK counties and
	 ...
	 * @return string The full html for the select input.
	 */
	function provinsi_select($selected_code='', $default_abbr='', $select_name='provinsi', $class='')
	{
 	...
 	// Get the states for the selected country
			...
			foreach ($states as $abbrev)
			{
				$output .= "<option value='{$abbrev->kode}'";
				$output .= ($abbrev->kode == $selected_code) ? ' selected="selected"' : '';
				$output .= empty($selected_code) && ($default_abbr == $abbrev->kode) ? ' selected="selected"' : '';
				$output .= ">{$abbrev->nama}</option>\n";
			}
			$output .= "</select>\n";
...
if ( ! function_exists('universitas_select'))
{
	/**
	 * Creates a state/provience/county dropdown form input based on the entries in the address.states config.
	 * The word "state" is used but the structure can be used for Canadian proviences, Irish and UK counties and
	 ...
	 * @return string The full html for the select input.
	 */
	function unversitas_select($selected_code='', $default_abbr='', $select_name='universitas', $class='')
	{
 	...
 	// Get the states for the selected country
			...
			$output  = '<select required name="'. $select_name . '" id="' . $select_name . '" ' . $class . ' >' . PHP_EOL;
			$output .= '<option value="">--Pilih Universitas--</option>' . PHP_EOL;
			foreach ($states as $abbrev)
			{
				$output .= "<option value='{$abbrev->id_universitas}'";
				$output .= ($abbrev->id_universitas == $selected_code) ? ' selected="selected"' : '';
				$output .= empty($selected_code) && ($default_abbr == $abbrev->id_universitas) ? ' selected="selected"' : '';
				$output .= ">{$abbrev->universitas}</option>\n";
			}
			$output .= "</select>\n";
