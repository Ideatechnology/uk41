	...
	private function save_settings($extended_settings=array())
	{
		...
		$data = array(
			array('name' => 'site.title', 'value' => $this->input->post('title')),
                        array('name' => 'site.meta_description', 'value' => $this->input->post('meta_description')),
                        array('name' => 'site.meta_keyword', 'value' => $this->input->post('meta_keyword')),
                        array('name' => 'site.meta_robot', 'value' => $this->input->post('meta_robot')),
