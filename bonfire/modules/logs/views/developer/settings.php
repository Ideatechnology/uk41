...
<div class="admin-box">
	...
	<fieldset>
		...
		<div class="form-group">
			<label for="log_threshold" class="col-xs-2 control-label"><?php echo lang('log_the_following'); ?></label>
			<div class="col-xs-5">
				<select name="log_threshold" id="log_threshold" class="form-control" style="width: auto; max-width: none;">
