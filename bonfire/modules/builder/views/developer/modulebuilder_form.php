		...
		<div>
			...
			<fieldset id="module_details">
				...
				<div class="form-group<?php echo form_has_error('module_name') ? ' error' : ''; ?>">
					<label for="module_name" class="col-xs-2 control-label block"><?php echo lang('mb_form_mod_name'); ?></label>
					<div class="col-xs-5">
				...
				<div class="form-group mb_advanced<?php echo form_has_error('module_description') ? ' error' : ''; ?>">
					<label for="module_description" class="col-xs-2 control-label block"><?php echo lang('mb_form_mod_desc'); ?></label>
					<div class="col-xs-5">
				...
				<div class="form-group mb_advanced">
					<label class="col-xs-2 control-label block" id="contexts_label"><?php echo lang('mb_form_contexts'); ?></label>
					<div class="col-xs-5" aria-labelledby="contexts_label" role="group">
				...
				<div class="form-group mb_advanced<?php echo form_has_error('form_action') ? ' error' : ''; ?>">
					...
					<label class="col-xs-2 control-label" id="form_action_label"><?php echo lang('mb_form_actions'); ?></label>
					<div class="col-xs-5" aria-labelledby="form_action_label" role="group">
				...
				<div class="form-group mb_advanced">
					<label class="col-xs-2 control-label" for="role_id"><?php echo lang('mb_form_role_id'); ?></label>
					<div class="col-xs-5">
				...
				<div class="form-group">
                    <label class='col-xs-2 control-label' for='mb_module_db'><?php echo lang('mb_module_db'); ?></label>
					<div class="col-xs-5" id='mb_module_db'>
			...
			<fieldset id="db_details">
				...
				<div class="form-group mb_advanced<?php echo form_has_error('table_name') ? ' error' : ''; ?>">
					<label for="table_name" class="col-xs-2 control-label block"><?php echo lang('mb_form_table_name'); ?></label>
					<div class="col-xs-5">
				...
				<div class="form-group mb_advanced<?php echo form_has_error('form_error_delimiters') ? ' error' : ''; ?>">
					<label for="form_error_delimiters" class="col-xs-2 control-label block"><?php echo lang('mb_form_err_delims'); ?></label>
					<div class="col-xs-5">
				...
				<div class="form-group mb_advanced">
					<label for="use_soft_deletes" class="col-xs-2 control-label block"><?php echo lang('mb_form_soft_deletes'); ?></label>
					<div class="col-xs-5">
				...
				<div class="form-group mb_advanced">
					<label for="use_created" class="col-xs-2 control-label block"><?php echo lang('mb_form_use_created'); ?></label>
					<div class="col-xs-5">
				...
				<div class="form-group mb_advanced<?php echo form_has_error('created_field') ? ' error' : ''; ?>">
					<label for="created_field" class="col-xs-2 control-label block"><?php echo lang('mb_form_created_field'); ?></label>
					<div class="col-xs-5">
				...
				<div class="form-group mb_advanced">
					<label for="use_modified" class="col-xs-2 control-label block"><?php echo lang('mb_form_use_modified'); ?></label>
					<div class="col-xs-5">
				...
				<div class="form-group mb_advanced<?php echo form_has_error('modified_field') ? ' error' : ''; ?>">
					<label for="modified_field" class="col-xs-2 control-label block"><?php echo lang('mb_form_modified_field'); ?></label>
					<div class="col-xs-5">
				...
				<div class="form-group mb_new_table<?php echo form_has_error('primary_key_field') ? ' error' : ''; ?>">
					<label for="primary_key_field" class="col-xs-2 control-label block"><?php echo lang('mb_form_primarykey'); ?></label>
					<div class="col-xs-5">
				...
				<div id="field_numbers" class="form-group">
					<label class="col-xs-2 control-label"><?php echo lang('mb_form_fieldnum'); ?></label>
			...
			<div<?php echo $count % 2 ? ' class="left"' : ''; ?>>
				<fieldset id="field<?php echo $count; ?>_details">
					...
					<div class="form-group <?php echo form_has_error("view_field_label{$count}") ? 'error' : ''; ?>">
						<label class="col-xs-2 control-label" for="view_field_label<?php echo $count; ?>"><?php echo lang('mb_form_label'); ?></label>
						<div class="col-xs-5">
							<input name="view_field_label<?php echo $count; ?>" class="form-control" id="view_field_label<?php echo $count; ?>" type="text" value="<?php echo set_value("view_field_label{$count}", isset($existing_table_fields[$count]) ? ucwords(str_replace("_", " ", $existing_table_fields[$count]['name'])) : ''); ?>" placeholder="<?php echo lang('mb_form_label_ph'); ?>" />
					...
					<div class="form-group <?php echo form_has_error("view_field_name{$count}") ? 'error' : ''; ?>">
						<label class="col-xs-2 control-label" for="view_field_name<?php echo $count; ?>"><?php echo lang('mb_form_fieldname'); ?></label>
						<div class="col-xs-5">
							<input name="view_field_name<?php echo $count; ?>" class="form-control" id="view_field_name<?php echo $count; ?>" type="text" value="<?php echo set_value("view_field_name{$count}", isset($existing_table_fields[$count]) ? $existing_table_fields[$count]['name'] : ''); ?>" maxlength="30" placeholder="<?php echo lang('mb_form_fieldname_ph'); ?>" />
					...
					<div class="form-group <?php echo form_has_error("db_field_length_value{$count}") ? 'error' : ''; ?>">
						<label class="col-xs-2 control-label" for="db_field_length_value<?php echo $count; ?>"><?php echo lang('mb_form_length'); ?></label>
						<div class="col-xs-5">
							<input name="db_field_length_value<?php echo $count; ?>" class="form-control" id="db_field_length_value<?php echo $count; ?>" type="text" value="<?php echo set_value("db_field_length_value{$count}", $default_max_len); ?>" placeholder="<?php echo lang('mb_form_length_ph'); ?>" />
							<span class="help-inline"><?php echo form_error("db_field_length_value{$count}"); ?></span>
						</div>
					</div>

					<div class="form-group">
						<label class="col-xs-2 control-label" id="validation_label<?php echo $count; ?>"><?php echo lang('mb_form_rules'); ?></label>
						<div class="col-xs-5" aria-labelledby="validation_label<?php echo $count; ?>" role="group">
					...
					<div class="form-group mb_advanced">
						<label class="col-xs-2 control-label" id="validation_limit_label<?php echo $count; ?>"><?php echo lang('mb_form_rules_limits'); ?></label>
						<div class="col-xs-5" aria-labelledby="validation_limit_label<?php echo $count; ?>" role="group">
