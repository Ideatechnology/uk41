	...
	<div class="tab-content">
		...
		<div class="tab-pane active" id="app-tab">
			<fieldset>
				...
				<?php echo form_open($this->uri->uri_string(), 'class="constrained form-horizontal"'); ?>
			...
			<fieldset>
				...
				<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
					...
					<div class="form-group">
						<label class="control-label col-xs-2" for="migration"><?php echo lang('mig_choose_migration'); ?></label>
						<div class="col-xs-5">
