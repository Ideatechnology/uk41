...
<div class="highlight"><pre><code class="scss"><span class="na">.placeholder(@color</span><span class="o">:</span> <span class="o">@</span><span class="n">input-color-placeholder</span><span class="p">)</span> <span class="p">{</span>
  <span class="na">&amp;</span><span class="o">:-</span><span class="n">moz-placeholder</span>            <span class="p">{</span> <span class="na">color</span><span class="o">:</span> <span class="o">@</span><span class="no">color</span><span class="p">;</span> <span class="p">}</span> <span class="c1">// Firefox 4-18</span>
  <span class="na">&amp;</span><span class="o">::-</span><span class="n">moz-placeholder</span>           <span class="p">{</span> <span class="na">color</span><span class="o">:</span> <span class="o">@</span><span class="no">color</span><span class="p">;</span> <span class="p">}</span> <span class="c1">// Firefox 19+</span>
...
<div class="highlight"><pre><code class="scss"><span class="nn">#gradient</span> <span class="o">&gt;</span> <span class="nc">.striped</span><span class="o">(</span><span class="nn">#333</span><span class="o">;</span> <span class="nn">#000</span><span class="o">;</span> <span class="nt">45deg</span><span class="o">);</span>
</code></pre></div>
...
<div class="bs-docs-section">
  ...
  <p class="lead">While Bootstrap is built on Less, it also has an <a href="">official Sass port</a>. We maintain it in a separate GitHub repository and handle updates with a conversion script.</p>
  ...
  <p>Visit the <a href="">Sass port's GitHub repository</a> to see these files in action.</p>


  <h2 id="sass-installation">Installation</h2>
  <p>For information on how to install and use Bootstrap for Sass, consult the <a href="">GitHub repository readme</a>. It's the most up to date source and includes information for use with Rails, Compass, and standard Sass projects.</p>
  <p>
    <a class="btn btn-lg btn-outline" href="">Bootstrap for Sass</a>
  </p>
</div>
