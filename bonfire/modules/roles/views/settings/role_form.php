...
<div class="admin-box">
	...
	<fieldset>
		...
		<div class="form-group <?php echo form_has_error('role_name') ? 'error' : ''; ?>">
			<label class="col-xs-2 control-label" for="role_name"><?php echo lang('role_name'); ?></label>
			<div class="col-xs-5">
		...
		<div class="form-group <?php echo form_has_error('description') ? 'error' : ''; ?>" style="vertical-align: top">
			<label class="col-xs-2 control-label" for="description"><?php echo lang('bf_description'); ?></label>
			<div class="col-xs-5">
		...
		<div class="form-group <?php echo form_has_error('login_destination') ? 'error' : ''; ?>">
			<label class="col-xs-2 control-label" for="login_destination"><?php echo lang('role_login_destination'); ?>?</label>
			<div class="col-xs-5">
        ...
        <div class="form-group">
            <label class="col-xs-2 control-label" for="default_context"><?php echo lang('role_default_context') ?></label>
            <div class="col-xs-5">
		...
		<div class="form-group <?php echo form_has_error('default') ? 'error' : ''; ?>">
			<label class="col-xs-2 control-label" for="default"><?php echo lang('role_default_role')?></label>
			<div class="col-xs-5">
		...
		<div class="form-group">
			<label class="col-xs-2 control-label" id="can_delete_label"><?php echo lang('role_can_delete_role'); ?>?</label>
			<div class="col-xs-5" aria-labelledby="can_delete_label" role="group">
