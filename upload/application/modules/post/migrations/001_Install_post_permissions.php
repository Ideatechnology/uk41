...
class Migration_Install_post_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Post.Content.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Post.Content.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Post.Content.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Post.Content.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
