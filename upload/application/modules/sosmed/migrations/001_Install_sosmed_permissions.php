...
class Migration_Install_sosmed_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Sosmed.Content.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Sosmed.Content.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Sosmed.Content.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Sosmed.Content.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
