...
<div id="login">
	...
	<?php echo form_open('login', array('autocomplete' => 'off','class'=>'form-signin')); ?>
 <div class="">
 <h2>Silakan Untuk Login</h2><hr />
    ...
    <label>
		...
		<div class="form-group">
				...
				<input class="btn btn-lg btn-primary btn-block ui-btn ui-btn-c" type="submit" name="log-me-in" id="submit" value="<?php e(lang('us_let_me_in')); ?>" tabindex="5" />
		</div>
